...
class ArcballControl {
    ...
    constructor(canvas, updateCallback) {
        ...
        this.onPointerLeave = () => { this.isPointerDown = false; };
...
class InfiniteGridMenu {
    ...
    #render() {
        ...
        gl.clearColor(1.0, 0.843, 0.0, 1.0); // Yellow #FFD700
...
export default function InfiniteMenu({ items = [] }) {
    ...
    const handleButtonClick = () => {
        ...
        const link = activeItem.link.trim();
    ...
    const handleCanvasPointerUp = (e) => {
        ...
        // If click was short and didn't move much, treat as click
        if (dt < 500 && Math.sqrt(dx * dx + dy * dy) < 30) {
            console.log('Canvas click detected, opening link...');
            handleButtonClick();
        }
    };
